...
for cnt in contours5:
        ...
        [x,y,w,h] = cv2.boundingRect(cnt)
       	cv2.rectangle(image5,(x,y),(x+w,y+h),(0,0,255),2)
...
for cnt in contours6:
        ...
        [x,y,w,h] = cv2.boundingRect(cnt)
       	cv2.rectangle(image6,(x,y),(x+w,y+h),(0,0,255),2)
       	roi = thresh6[y:y+h,x:x+w]
...
for cnt in contours7:
        ...
        [x,y,w,h] = cv2.boundingRect(cnt)
       	cv2.rectangle(image7,(x,y),(x+w,y+h),(0,0,255),2)
       	roi = thresh7[y:y+h,x:x+w]
...
for cnt in contours8:
        ...
        [x,y,w,h] = cv2.boundingRect(cnt)
       	cv2.rectangle(image8,(x,y),(x+w,y+h),(0,0,255),2)
       	roi = thresh8[y:y+h,x:x+w]
...
for cnt in contours9:
        ...
        [x,y,w,h] = cv2.boundingRect(cnt)
       	cv2.rectangle(image9,(x,y),(x+w,y+h),(0,0,255),2)
       	roi = thresh9[y:y+h,x:x+w]
